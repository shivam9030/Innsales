        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionValue = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InnSales_Promotion", x => x.PromotionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPromoProduct = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isUniqueCode = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InnSales_Promocode", x => x.PromoCodeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReadableOrderId = table.Column<string>(type: "text", nullable: false),
                    ...
                    CardExpiryDate = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardExpiryDate = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_PromoCodeId",
                table: "BasketItems",
                column: "PromoCodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PromoCodeId",
                table: "OrderItems",
                column: "PromoCodeId");
